...
;(function($){
	...
	$.fn.bxSlider = function(options){
		...
		var updatePagerActive = function(slideIndex){
			...
			// remove all pager different selection classes
			slider.pagerEl.find('a').removeClass('line-up');
			// added to create different selection
			slider.pagerEl.find('a:lt('+slideIndex+')').addClass('line-up');
